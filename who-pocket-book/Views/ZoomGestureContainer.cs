        ...
        public void OnPanUpdated(object sender, PanUpdatedEventArgs e)
        {
            ...
            switch (e.StatusType)
            {
                case GestureStatus.Running:
                    ...
                    double maxX = Math.Max(0, App.Current.MainPage.Width - ((Content.Width * Content.Scale) / 2));
                    ...
                    double maxY = Math.Max(0, App.Current.MainPage.Height - ((Content.Height * Content.Scale) / 2));
